class WishesController < ApplicationController
  ...
  def create
    ...
    SmallStep.create(text: small_step_params[:text1], wish_id: wish.id)
    SmallStep.create(text: small_step_params[:text2], wish_id: wish.id)
    SmallStep.create(text: small_step_params[:text3], wish_id: wish.id)
  end
